...
@OpenAPIDefinition(
		info=@Info(
					title="Microservices REST API  CRUD v1 Documentation",
					description="Microservices REST API CRUD v1 Dcoumentation",
					version="v01July2024",
					contact=@Contact(
	   ...
	   externalDocs= @ExternalDocumentation(
											description="Microservices REST API CRUD v1 Documentation",
