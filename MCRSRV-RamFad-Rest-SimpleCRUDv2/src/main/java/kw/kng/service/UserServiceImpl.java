...
import kw.kng.mapper.AutoUserMapper;
...
public class UserServiceImpl implements UserService 
{
	...
	public UserDto createUser(UserDto userDto)
	{
		...
		//	Users user= modelMapper.map(userDto, Users.class); 				// -->	ModelMapper method
		Users user= AutoUserMapper.MAPPER.mapToUser(userDto); 		// -->	MapStruct method
		...
		//	 return modelMapper.map(savedUser, UserDto.class); 				// -->	ModelMapper method
		return AutoUserMapper.MAPPER.mapToUserDto(savedUser);		// -->	MapStruct method
	...
	public List<UserDto> createUserList(List<UserDto> userDto) 
	{
		...
		//List<Users> userList= userDto.stream().map(dto -> modelMapper.map(dto, Users.class )).collect(Collectors.toList());					// -->	ModelMapper method
		List<Users> userList= userDto.stream().map(dto ->  AutoUserMapper.MAPPER.mapToUser(dto)).collect(Collectors.toList());			// -->	MapStruct method
		...
		//return savedUserList.stream().map(u ->modelMapper.map(u, UserDto.class)).collect(Collectors.toList());							// -->	ModelMapper method
		return savedUserList.stream().map(u ->AutoUserMapper.MAPPER.mapToUserDto(u)).collect(Collectors.toList());				// -->	MapStruct method
	...
	public UserDto getUserById(Long userId) 
	{
		...
		//return modelMapper.map(user, UserDto.class); 							// -->	ModelMapper method
		return AutoUserMapper.MAPPER.mapToUserDto(user);				// -->	MapStruct method
	}
	...
	public List<UserDto> getAllUser() 
	{
		...
		//Transfer ENTITY to DTO
		//return userList.stream().map((u) -> modelMapper.map(u, UserDto.class)).collect(Collectors.toList());				// -->	ModelMapper method
		return userList.stream().map((u) ->AutoUserMapper.MAPPER.mapToUserDto(u)).collect(Collectors.toList());		// -->	MapStruct method
	...
	public UserDto updateUser(Long userId, UserDto userDto) 
	{
		...
		//Transfer ENTITY to DTO
		//return modelMapper.map(updatedUsers, UserDto.class);							// -->	ModelMapper method
		return AutoUserMapper.MAPPER.mapToUserDto(updatedUsers);				// -->	MapStruct method
