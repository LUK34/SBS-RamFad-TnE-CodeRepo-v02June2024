...
@OpenAPIDefinition(
		info=@Info(
					title="Microservices REST API CRUD v2 Documentation",
					description="Microservices REST API CRUD v2 Dcoumentation",
					version="v01July2024",
					contact=@Contact(
	   ...
	   externalDocs= @ExternalDocumentation(
											description="Microservices REST API CRUD v2 Documentation",
											url="https://www.javaguides.net/external-doc.html"
										)
)
@SpringBootApplication
public class McrsrvRamFadRestSimpleCrudApplication
{
	@Bean
	...
	public static void main(String[] args) {
		SpringApplication.run(McrsrvRamFadRestSimpleCrudApplication.class, args);
	}
